...
class CompanyInformationRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'appleStoreURL': debugSerializeParam(
          appleStoreURL,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
        ...
        'playStoreURL': debugSerializeParam(
          playStoreURL,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
        ...
        'coverImage': debugSerializeParam(
          coverImage,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
        ...
        'company_bio': debugSerializeParam(
          companyBio,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
