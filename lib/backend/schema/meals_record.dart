...
class MealsRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'meal_image': debugSerializeParam(
          mealImage,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
        ...
        'meal_ingredients': debugSerializeParam(
          mealIngredients,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
        ...
        'meal_allergens': debugSerializeParam(
          mealAllergens,
          ParamType.String,
          isList: true,
          link:
        ...
        'meal_favorites': debugSerializeParam(
          mealFavorites,
          ParamType.DocumentReference,
          isList: true,
          link:
        ...
        'meal_calories': debugSerializeParam(
          mealCalories,
          ParamType.int,
          link:
              'https://app.flutterflow.io/project/med-reminders-9qcana?tab=database',
