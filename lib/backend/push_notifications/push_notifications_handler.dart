...
final parametersBuilderMap =
  ...
  'addTreatment': ParameterData.none(),
  'Accueil': ParameterData.none(),
  'DetailsTreatment': (data) async => ParameterData(
        allParams: {
          'name': getParameter<String>(data, 'name'),
          'description': getParameter<String>(data, 'description'),
          'posologie': getParameter<int>(data, 'posologie'),
          'endDate': getParameter<DateTime>(data, 'endDate'),
          'notified': getParameter<bool>(data, 'notified'),
        },
      ),
};
