...
import 'schema/treatment_record.dart';
...
export 'schema/treatment_record.dart';
...
/// Functions to query TreatmentRecords (as a Stream and as a Future).
Future<int> queryTreatmentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TreatmentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TreatmentRecord>> queryTreatmentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TreatmentRecord.collection,
      TreatmentRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TreatmentRecord>> queryTreatmentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
