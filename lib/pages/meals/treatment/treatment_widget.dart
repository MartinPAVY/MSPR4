...
class TreatmentWidget extends StatefulWidget {
  const TreatmentWidget({super.key, this.addModelFn});
...
class _TreatmentWidgetState extends State<TreatmentWidget> with RouteAware {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Treatment'});
  }
