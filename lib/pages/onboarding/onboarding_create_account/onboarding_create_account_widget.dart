...
class OnboardingCreateAccountWidget extends StatefulWidget {
  const OnboardingCreateAccountWidget({super.key, this.addModelFn});
...
class _OnboardingCreateAccountWidgetState
    extends State<OnboardingCreateAccountWidget> with RouteAware {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ONBOARDING_CREATE_ACCOUNT_CRER_UN_COMPTE');
                          ...
                          child: StreamBuilder<List<CompanyInformationRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              _model.debugBackendQueries[
                                      'richTextCompanyInformationRecord_RichText_t8sm75qz'] =
                                  debugSerializeParam(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          '6ongsqy2' /* En créant un compte, vous acce... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                      ...
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          '2pblnw75' /* conditions générales d'utilisa... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
