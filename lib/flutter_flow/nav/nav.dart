...
const debugRouteLinkMap = {
  '/splash':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=Splash',
  '/sign-in':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=SignIn',
  '/onboarding':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=Onboarding_Slideshow',
  '/create-account':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=Onboarding_CreateAccount',
  '/profil':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=Profil',
  '/edit-profile':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=EditProfile',
  '/forgot-password':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=ForgotPassword',
  '/addTreatment':
      'https://app.flutterflow.io/project/med-reminders-9qcana?tab=uiBuilder&page=addTreatment',
  '/accueil':
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'addTreatment',
              path: 'addTreatment',
              builder: (context, params) => AddTreatmentWidget(),
            ),
            FFRoute(
              name: 'Accueil',
              path: 'accueil',
            ...
            FFRoute(
              ...
              path: 'detailsTreatment',
              builder: (context, params) => DetailsTreatmentWidget(
